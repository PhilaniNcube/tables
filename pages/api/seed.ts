...
export default async function handler(
  ...
  // const {data, error} = await supabaseServerClient.from('Restaurant').insert(
  //   [        {
  ...
  // await supabaseServerClient.from('Item').insert([
  //     {
  ...
  //         first_name: "Laith",
  //         last_name: "Harb",
  //         text: "Restaurant was loud and crowded. Food is not worth the ",
  //         rating: 3,
  //         restaurant_id: 15,
  //         user_id: userLaith.id,
  //       },
